...
脚本会生成 `build/Open Notch.app`、`build/Open Notch.zip` 和可直接转发给朋友的 `build/Open Notch 0.7.2.dmg`。将 App 移到 `/Applications` 后启动，在系统设置中授予辅助功能权限，再回到 Open Notch 的 General / 通用页面点击 **Recheck / 重新检查**。
