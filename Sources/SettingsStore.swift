...
final class SettingsStore: ObservableObject {
    ...
    private init() {
        ...
        // Restore Apple modules that an older experimental build could hide
        // and then mark read-only. The PR #7 bridge can manage these modules,
        // so later user choices remain available after this one-time repair.
